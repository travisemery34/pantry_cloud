 ...
 *
 */
public class AsyncRestSignup extends AsyncTask<String, Void, String>{

	private static final String TAG = "AsyncRestSignup";
	private static final String URL = "http://www.emeree.net/pc/account/rest_user_functions.php";
	private static final String ACTION = "?action=signup";
	...
	protected String doInBackground(String... arg0) {
        ...
        try {
        	...
        	loginParams.add(new BasicNameValuePair("first_name", arg0[2]));
        	loginParams.add(new BasicNameValuePair("last_name", arg0[3]));
